...
siW_recall = "~/prog/bedfiles/mysiW/siw_3/refined/siW3_refined_annotated.bed"
...
siw_gtf = siw_df[,c("seqnames", "source", "identifier", "start",
                    ...
                    "attr")]
write.table(siw_gtf, file = "/Users/IEO5559/prog/DRB_TTseq/siW_ttome/siW_only_dedup_names.gtf",
            sep = "\t",
